...
<head>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* Hero - Διορθωμένο για να μην κόβεται ο τίτλος */
        .hero { text-align: center; padding: 40px 16px 24px; background: radial-gradient(ellipse at top, rgba(229,9,20,0.15), transparent 60%); width: 100%; overflow: hidden; }
        .hero h1 { font-size: clamp(24px, 6vw, 32px); font-weight: 900; color: var(--primary); letter-spacing: -0.5px; line-height: 1.2; word-wrap: break-word; }
        .hero p { font-size: 14px; color: var(--text-muted); margin-top: 8px; letter-spacing: 0.5px; text-transform: uppercase; }

        /* CTA - Διορθωμένο για κάθετη στοίχιση στα κινητά */
        .cta-row { display: flex; flex-direction: column; gap: 12px; align-items: center; padding: 0 16px 32px; width: 100%; }
        .cta-btn { display: inline-flex; align-items: center; justify-content: center; gap: 8px; padding: 14px 20px; border-radius: 50px; font-weight: 800; font-size: 14px; transition: 0.2s; border: 1px solid transparent; width: 100%; max-width: 320px; }
        ...
        /* Sticky Ads 15% (ROLL UP / ROLL DOWN) */
        .sticky-ad { 
            position: fixed; 
            left: 0; 
            width: 100%; 
        ...
        .sticky-top .sticky-close { bottom: -14px; right: 16px; top: auto; }
